						...
						<security:authorize access="isAuthenticated()">
							<li>
								<a href="${s:mvcUrl('PC#listar').build() }">
									<s:message code="menu.produtos" ></s:message>
								</a>
							</li>
							<li>
								<a href="${s:mvcUrl('PSC#listar').build() }">
									<s:message code="menu.pedidos" ></s:message>
								</a>
							</li>
							<li>
								<a href="${s:mvcUrl('UC#listar').build() }">
									<s:message code="menu.usuarios" ></s:message>
								</a>
							</li>
						</security:authorize>
						<li>
